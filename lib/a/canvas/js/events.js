...
// // Audio stuff
// // unfortunately, Tone doesn't work on all platforms
// // (specifically EdgeHTML) so we delay setting the value here
// var synth;
// try {
//     synth = new Tone.PolySynth().toDestination();
// } catch(e) {
// }
// function playseq(notes, subdivision) {
//     // Plays a sequence of notes at a fixed interval
//     subdivision = subdivision || '4n';
//     try {
//         let i = 0;
//         let loop = new Tone.Loop(time => {
//             try {
//                 synth.triggerAttackRelease(notes[i], subdivision);
//             } catch (e) {
//                 external.invoke('debug/e-playseq-loop/' + e);
//             }
//             i += 1;
//             if (i >= notes.length) {
//                 loop.stop();
...
//     } catch (e) {
//         external.invoke('debug/e-playseq/' + e);
//     }
// }
